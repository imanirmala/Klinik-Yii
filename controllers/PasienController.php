...
/**
 * PasienController implements the CRUD actions for TbPasien model.
 */
class PasienController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id_pasien' => $model->id]);
        }
    ...
    {
        if (($model = TbPasien::findOne(['id_pasien' => $id])) !== null) {
            return $model;
        }
